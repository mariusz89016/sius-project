...
#out
artistToIDFile = "Data/artistToID4ranks.npy"
finalDataFile = 'Data/finalData4ranks.txt'
...
for xxx in range(4):
    for a in artistRanks.keys():
        ...
        if not (o[0] >= minEachRank and o[1] >= minEachRank and o[2] >= minEachRank and o[3] >= minEachRank):
            eraseArtist[a] = 1
